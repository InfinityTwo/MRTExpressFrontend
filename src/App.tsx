  ...
  return (
    <div className="App">
      ...
      <div className="sidePanel">
        <SearchArea setFilter={setFilter} filterEnabled={filterEnabled} searchEnabled={searchEnabled} setSearch={setSearch} setAxiosData={setAxiosData} stationsData={stationsData} lineColours={lineColours} />
        {
          filterEnabled
        ...
        }
        {
          ...
          ? <Results axiosData={axiosData} stationsData={stationsData} idToName={idToName} lineColours={lineColours} />
          : <></>
        }
      </div>
    </div>
